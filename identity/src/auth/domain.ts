/**
 * Derived from archetypes/solution-intel/reference-impl/identity/src/auth/domain.ts
 * Source archetype: solution-intel (which adapts bangauth as the simple-auth instance)
 ...
 * Modifications: none (verbatim derivation)
 */
