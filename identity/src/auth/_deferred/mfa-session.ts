...
/**
 * Derived from archetypes/solution-intel/reference-impl/identity/src/auth/_deferred/mfa-session.ts
 * Source archetype: solution-intel (which adapts bangauth)
 ...
 * Modifications: none (verbatim derivation; not in runtime path)
 */
