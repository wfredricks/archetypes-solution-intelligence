/**
 * Derived from archetypes/solution-intel/reference-impl/cli/src/http.ts
 ...
 * Modifications:
 *   - Class names SIIdentityClient/SIHttpError preserved as the public
 *     contract surface (see ADOPTION-FINDINGS.md "class-naming" note);
 *     they are the simple-auth client identifier and remain stable across
 *     adoptions
 *   - Docstring references SI/I updated to ASI/I where they describe
 *     the target service
 */

/**
 * Typed HTTP client for ASI/I.
 *
